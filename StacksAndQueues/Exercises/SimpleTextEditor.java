...
public class SimpleTextEditor {
                ...
                case "4":
                    ...
                    switch (lastCommandType){
                        case "1":
                            ...
                            break;
                        case "2":
                            String elementsToBringBack = removedElements.pop();
                            executeAdd(elementsToBringBack, text);
                            break;
                    }
                    break;
    ...
    private static void executeAdd(String commandArguments, StringBuilder text) {
        text.append(commandArguments);
    }
}
